...
if do_autoscaling:
    ...
    autoscaled_y_supporting = (y_supporting - y_supporting.mean()) / y_supporting.std(ddof=1)
    ...
    autoscaled_y_supporting = y_supporting.copy()
    autoscaled_y_train_target = y_target.copy()
...
if transfer_learning_flag == 1:
    ...
    autoscaled_x_test = autoscaled_x_test_target.copy()
    autoscaled_y_train = np.r_[autoscaled_y_supporting, autoscaled_y_train_target]
